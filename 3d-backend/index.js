...
app.post('/save', upload.fields([
    ...
    try {
        ...
        const profileImage = req.files.profile ? `/textures/${req.files.profile[0].filename}` : existingWallname.profile;
        ...
        await Projects.findOneAndUpdate({}, {
            project1Image: req.files.project1Image ? `/textures/${req.files.project1Image[0].filename}` : existingProjects.project1Image,
            link1: link1 || existingProjects.link1,
            project2Image: req.files.project2Image ? `/textures/${req.files.project2Image[0].filename}` : existingProjects.project2Image,
            link2: link2 || existingProjects.link2,
            project3Image: req.files.project3Image ? `/textures/${req.files.project3Image[0].filename}` : existingProjects.project3Image,
            link3: link3 || existingProjects.link3,
            project4Image: req.files.project4Image ? `/textures/${req.files.project4Image[0].filename}` : existingProjects.project4Image,
